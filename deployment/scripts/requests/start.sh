...
# Requests Scraper 启动脚本 - 适配新结构
# 统一的结果处理：/results/requests/YYYY-MM-DD_HH-MM-SS/ 目录结构

echo "🕷️ Starting Requests Scraper (New Structure)..."
...
if python3 -m src.scraper_app.main --scraper requests --input data/input/webs.txt --output "$RESULTS_DIR"; then
