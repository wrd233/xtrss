...
# Trafilatura Scraper 启动脚本 - 适配新结构
# 统一的结果处理：/app/data/output/YYYY-MM-DD_HH-MM-SS/ 目录结构

echo "🔍 Starting Trafilatura Scraper (New Structure)..."
...
if python3 -m src.scraper_app.main --scraper trafilatura --input data/input/webs.txt --output "$RESULTS_DIR"; then
